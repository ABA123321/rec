...
export const GAME_ABI = [
  ...
  "function draw(uint256 count) returns (uint256 totalCost)",
  "function drawOpensAt() view returns (uint40)",
  "function synthesisCost(uint8 targetLevel) view returns (uint256 ae, uint256 bf, uint256 mr, uint256 es, uint256 adventAmount)",
  "function synthesize(uint8 targetLevel) returns (uint256 tokenId)",
